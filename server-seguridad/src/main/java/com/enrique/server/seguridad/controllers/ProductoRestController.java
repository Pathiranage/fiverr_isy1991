...
public class ProductoRestController {
    ...
    // Devuelve el producto creado, recibir� el objeto producto en JSON
    //	@Secured("ROLE_ADMIN")
    ...
    public ResponseEntity<?> update(@RequestBody Producto producto, @PathVariable Long id) {
        ...
        response.put("mensaje", "Producto actualizado con �xito");
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        ...
        response.put("mensaje", "Producto eliminado con �xito");
